...
route('GET', '/item/list', require('./serverApi/item/list'));
route('GET', '/item/get', require('./serverApi/item/get'));
route('POST', '/item/set', require('./serverApi/item/set'));
route('GET', '/language/list', require('./serverApi/language/list'));
